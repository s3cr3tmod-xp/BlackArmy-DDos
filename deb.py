...
def worker(idx, args, job_q: queue.Queue, metrics: Metrics, start_ts, end_ts):
    ...
    while not shutdown_flag.is_set():
        ...
        if time.time() - last_log >= 1.0 and idx == 0:
            ...
            print(f"\r\033[48;5;7m\033[30mthreads {args.threads} |\033[0m \033[32mSent {total} \033[33mStarting-attack \033[32mcode: \033[0m")
            print(f"\r\033[36mInfo-target URL: \033[38;5;39m {str(url)} \033[37mReqs_execution")
            sys.stdout.flush()
            print(f"\r\033[38;5;220mInfo-target URL: \033[38;5;39m {str(url)} \033[37mpayload")
            sys.stdout.flush()
            last_log = time.time()

...
"""
print("\033[32m╔══════════════════════════════════════════════════╗")
print("\033[32m║\033[48;5;4m\033[37m       Design by: Kunfayz_s3cr3tmod-xp     \033[0m\033[32m║")
print("\033[32m║\033[48;5;4m\033[37m        Only for approved communities      \033[0m\033[32m║")
print("\033[32m╚══════════════════════════════════════════════════╝")
...
def worker(idx, args, job_q: queue.Queue, metrics: Metrics, start_ts, end_ts):
    ...
    while not shutdown_flag.is_set():
        ...
        if time.time() - last_log >= 1.0 and idx == 0:
            ...
            print(f"\r\033[48;5;3mthreads {args.threads} |\033[0m \033[32mSent {total} \033[33mStarting-attack \033[32mcode: \033[0m")
            print(f"\r\033[36mInfo-target URL: \033[38;5;39mm" +str(url)+ " \033[37mReqs_execution")
            sys.stdout.flush()
            last_log = time.time()
